...
export default function Home() {
  ...
  return (
    <div className="bg-white py-4 sm:py-8 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        {/* Layout Grid:
            Hero + 3 Steps (Coluna Esquerda) | 3 Produtos Destaque (Coluna Direita)
        */}
        <div className="grid grid-cols-1 lg:grid-cols-12 lg:grid-rows-[1fr_auto] gap-6 sm:gap-8 lg:gap-x-10 lg:gap-y-4 items-stretch">
          ...
          <div className="order-1 lg:col-span-8 lg:row-start-1 flex flex-col justify-center py-2 sm:py-4 h-full relative isolate">
            ...
            <div
              className="absolute -inset-10 sm:-inset-24 lg:-inset-36 pointer-events-none select-none -z-10 bg-[url('/hero-pattern.svg')] bg-repeat"
              style={{
            ...
            <div className="space-y-4 sm:space-y-6 text-center lg:text-left relative z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-full bg-gray-100 text-gray-900 text-xs font-bold tracking-wide">
                <span>Cantina digital IFRS</span>
              </div>

              <div className="space-y-3 sm:space-y-4">
                <h1 className="text-3xl sm:text-5xl lg:text-6xl font-semi-bold tracking-tight text-gray-900 leading-[1.15]">
                  Alimente sua rotina. <br />
                  <span className="text-primary-600">Sem perder o intervalo.</span>
                </h1>
                <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-xl mx-auto lg:mx-0 leading-relaxed font-normal">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 pt-1">
                <Link
                  to="/cardapio"
                  className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 rounded-full border border-primary-500 bg-primary-500 hover:bg-primary-600 text-white font-bold text-sm sm:text-base inline-flex items-center justify-center gap-2 transition-colors cursor-pointer active:scale-98"
                >
                ...
                <a
                  ...
                  className="bg-white w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 rounded-full border border-gray-200 hover:bg-gray-100 text-gray-700 font-semibold text-sm sm:text-base inline-flex items-center justify-center gap-2 transition-colors cursor-pointer active:scale-98"
                >
          ...
          <div className="order-2 lg:col-start-9 lg:col-end-13 lg:row-start-1 lg:row-span-2 grid grid-cols-1 sm:grid-cols-3 lg:flex lg:flex-col lg:justify-between gap-3.5 sm:gap-4 w-full h-full relative z-10">
            {produtosDestaque.map((produto) => (
              <div
                key={produto.id}
                className="h-48 sm:h-56 lg:h-58.75 w-full relative bg-gray-50 rounded-2xl sm:rounded-3xl overflow-hidden flex flex-col justify-between p-3 sm:p-3.5 shrink-0 shadow-xs sm:shadow-none"
              >
                ...
                <div className="flex items-center justify-between relative z-10">
                  <span className="backdrop-blur-md bg-white/75 text-gray-900 text-[11px] sm:text-xs font-bold px-2.5 sm:px-3 py-1 rounded-full border border-white/80 select-none">
                    {produto.badge}
                  </span>
                ...
                <div className="relative z-10 backdrop-blur-md bg-white/85 border border-white/90 rounded-xl sm:rounded-2xl p-2.5 sm:p-3 flex items-center justify-between gap-2.5">
                  ...
                  <Link
                    to="/cardapio"
                    className="bg-gray-900 hover:bg-black text-white font-bold text-xs px-3 sm:px-4 py-1.5 rounded-full transition-colors inline-flex items-center gap-1 shrink-0 cursor-pointer"
                  >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              {passos.map((item, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="min-h-[160px] sm:h-58.75 bg-gray-50/80 rounded-2xl sm:rounded-3xl p-3 sm:p-3.5 border border-gray-100 flex flex-col justify-between"
                  >
                    {/* Título e Descrição na base */}
                    <div className="px-1 pt-2 sm:pt-3 space-y-0.5">
                      <h3 className="text-base sm:text-lg mb-1 sm:mb-2 font-bold text-gray-900 leading-tight">
                        {item.title}
                      </h3>
                      <p className="text-xs sm:text-sm text-gray-500 font-normal leading-relaxed sm:leading-5">
                        {item.description}
                      </p>
                    </div>
                    {/* Container cinza arredondado preenchendo a área superior */}
                    <div className="bg-white shadow-xs rounded-xl sm:rounded-2xl p-3 sm:p-4 flex items-center justify-between h-14 sm:h-16.5 mt-3 sm:mt-0">
                      <Icon className="w-6 h-6 sm:w-8 sm:h-8 text-primary-600 stroke-[1.5]" strokeWidth={1.5} />
