...
/**
 * Footer Reutilizável - Cantina IFRS
 * Design minimalista e discreto para fechamento de layout.
 */
    ...
    <footer className="w-full bg-white border-t border-gray-100 text-gray-500 text-sm mt-auto py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          ...
          {/* Informações da Cantina & Direitos */}
          ...
          {/* Horário de Funcionamento & Localização Discreta */}
